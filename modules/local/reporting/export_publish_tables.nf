process EXPORT_PUBLISH_TABLES_TASK {
    ...
    def assembleBatchViews = batchIdInputs.indices.collect { idx ->
        ...
        ln '${normalizedDir}/cds.fna' "publish_batch_views/${batchId}/cds.fna" || cp '${normalizedDir}/cds.fna' "publish_batch_views/${batchId}/cds.fna"
        ...
        ln '${translatedDir}/proteins.faa' "publish_batch_views/${batchId}/proteins.faa" || cp '${translatedDir}/proteins.faa' "publish_batch_views/${batchId}/proteins.faa"
